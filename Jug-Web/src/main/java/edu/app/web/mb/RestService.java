...
//	list articles from Member 
	...
	@GET
	@Produces("application/json")
	 public List<Article> getAllArtilcesMember(@PathParam(value = "id") int idUser){
...
//	list articles from Speaker
	...
	@GET
	@Produces("application/json")
	 public List<Article> getAllArtilcesCategorie(@PathParam(value = "categorie") String categorie){
